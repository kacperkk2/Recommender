...
def precision_at_k(
    ...
    a = n_users
    b = rating_true[rating_true[col_user] == 0]
    c = rating_pred[rating_pred[col_user] == 0]
    d = df_hit_count
    e = df_hit
...
def mrr_at_k(
    ...
    df_hit_sorted["rr"] = 1 / df_hit_sorted["rank"]
    df_hit_sorted = df_hit_sorted.groupby(col_user).agg({"rr": "max"}).reset_index()
